...
// LoadJSON loads a json file from the res directory and returns the json as string. LoadJSON panics on errors.
...
// SaveGoldenFile saves a data structure as json to a file in the goldenfiles directory. SaveGoldenFile panics on errors.
